define('File/Attach/Abstract', [
...
], function (require, exports, tslib_1, Deferred, ParallelDeferred, moduleStubs, ObservableMixin, isDestroyed_1) {
    'use strict';
    ...
    function (_super) {
        ...
        Abstract.prototype._chooseNotify = function (chooseDef) {
            ...
            return chooseDef.addCallback(function (files) {
                ...
                var eventResults = files.map(function (file) {
                    ...
                    return Deferred.callbackWrapper(_this._notify(event, file), function (result) {
                        return Deferred.success(typeof result !== 'undefined' ? result : file);
                    });
                });
                ...
                return Array.prototype.slice.call(results).filter(function (res) {
                    return !!res;
                });
        ...
        tslib_1.__decorate([isDestroyed_1.isDestroyed], Abstract.prototype, 'setSelectedResource', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyed], Abstract.prototype, 'clearSelectedResource', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyed], Abstract.prototype, 'getSelectedResource', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyed], Abstract.prototype, 'addSelectedResource', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyedAsync], Abstract.prototype, 'upload', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyedAsync], Abstract.prototype, 'choose', null);
        tslib_1.__decorate([isDestroyed_1.isDestroyed], Abstract.prototype, 'getRegisteredResource', null);
        return Abstract;
    }(Observable);
    return Abstract;
});    /**
