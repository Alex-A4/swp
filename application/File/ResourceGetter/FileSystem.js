define('File/ResourceGetter/FileSystem', [
    'require',
    'exports',
    'tslib',
...
], function (require, exports, tslib_1, ResourceGetterBase, Deferred, ExtensionsHelper, filter, isDestroyed_1) {
    'use strict';
    var SEC = 1000;
    var MIN = 60 * SEC;
    ...
    function (_super) {
        ...
        FileSystem.prototype.getFiles = function () {
            ...
            var def = new Deferred().addCallback(function (files) {
                return filter(files, {
        ...
        tslib_1.__decorate([isDestroyed_1.isDestroyedAsync], FileSystem.prototype, 'getFiles', null);
        return FileSystem;
    }(ResourceGetterBase);
    return FileSystem;
});