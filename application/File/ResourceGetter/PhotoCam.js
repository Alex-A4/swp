...
define('File/ResourceGetter/PhotoCam', [
    'require',
    'exports',
    'tslib',
...
], function (require, exports, tslib_1, IResourceGetterBase, Deferred, detection, merge, OpenDialog, isDestroyed_1) {
    'use strict';
    ...
    function (_super) {
        ...
        PhotoCam.prototype.getFiles = function () {
            ...
            this._openDialog.execute({ componentOptions: { resultDeferred: this._chooseDef } }).addErrback(function (err) {
        ...
        tslib_1.__decorate([isDestroyed_1.isDestroyedAsync], PhotoCam.prototype, 'getFiles', null);
        return PhotoCam;
    }(IResourceGetterBase);
    return PhotoCam;
});