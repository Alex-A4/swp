 ...
 * @version 1.4.3
 */
define('Deprecated/Controls/FieldRadio/resources/ext/ui.checkbox', ["is!browser?/cdn/jquery-ui/1.8.5/jquery-ui-p2.min.js"], function(){
   (function($){
		...
		_addEvents: function(){
			...
			if(opts.addVisualElement){
				this.visualElement
                  ...
                  if (that.labels.find('input')[0] != that.element[0]){
