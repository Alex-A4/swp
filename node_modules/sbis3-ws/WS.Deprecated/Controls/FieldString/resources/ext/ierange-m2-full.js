	...
	convertToDOMRange: function (textRange, document) {
		function adoptBoundary(domRange, textRange, bStart) {
         ...
         try {
            ...
            if (cursor.compareEndPoints(bStart ? 'StartToStart' : 'StartToEnd', textRange) <= 0 && cursorNode.nextSibling) {
               // data node
...
document.createRangeForIE = function () {
	return new DOMRange(document);
};

var selection = new DOMSelection(document);
window.getSelectionForIE = function () {
	return selection;
};
