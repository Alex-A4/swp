define('Deprecated/Controls/DateRange/design/DesignPlugin',
   [
   "Deprecated/Controls/DateRange/DateRange",
   "Deprecated/Controls/FieldDate/design/DesignPlugin",
   "Deprecated/Controls/FieldFormatAbstract/design/DesignPlugin"
],
   function(DateRange){
   ...
   /**
    * @class DateRange.DesignPlugin
    * @extends DateRange
    * нужен, чтобы менять режим отображения через textView
    * @plugin
    */
   DateRange.DesignPlugin = DateRange.extendPlugin({
