import compatibility from 'Core/_Util/Compatibility';
import detection from 'Core/_Util/Detection';

const now = +new Date();
const timeShift2014 = +new Date(2014, 9, 26);
 ...
 * @public
 */
const constants = /** @lends Core/_Util/constants.prototype */{
   /**
    ...
    */
   compat: (typeof window === 'undefined' || window && window.location.href.indexOf('withoutLayout') === -1) &&
   (typeof window === 'undefined' || window.wsConfig.compatible !== false),
    ...
    */
   layoutConfig: {
      contentArea: ['#contentArea', '#contentAreaEdit', '#ctr']
   },
    ...
    */
   WINDOW_CLASSES: ['Lib/Control/FloatArea/FloatArea', 'Lib/Control/Window/Window', 'Deprecated/Controls/FieldEditAtPlace/FieldEditAtPlace'],
