define("cdn!jquery-ui/1.8.5/jquery-ui-1.8.5.custom.min.js", ["is!browser?/cdn/jquery-ui/1.12.1.2/jquery-ui-position-min.js"], function(){
   ...
   (function ($, undefined) {
      ...
      $.extend(Datepicker.prototype, {markerClassName:"hasDatepicker", maxRows:4, log:function () {
         ...
         return(new Date(a, b, 1, 12)).getDay()
