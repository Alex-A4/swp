 ...
 */
define("Data/_display/Ladder", ["require", "exports", "tslib", "Data/_display/Collection", "Data/type", "Data/collection", "Data/util", "Data/shim"], function (require, exports, tslib_1, Collection_1, type_1, collection_1, util_1, shim_1) {
    "use strict";
    ...
    var Ladder = /** @class */ (function (_super) {
        ...
        Ladder.prototype.setCollection = function (collection) {
            ...
            var reset = collection !== this._collection;
        ...
        Ladder.prototype.get = function (item, columnName) {
            return this.isPrimary(item, columnName)
                ? util_1.object.getPropertyValue(item, columnName)
                : '';
        };
        /**
        ...
        Ladder.prototype._spliceCollection = function (at, deleteCount, added) {
            ...
            (_a = this._collectionItems).splice.apply(_a, [at, deleteCount].concat(added));
        };
        ...
        Ladder.prototype._onCollectionChange = function (event, action, newItems, newItemsIndex, oldItems, oldItemsIndex) {
            ...
            switch (action) {
                ...
                default:
                    ...
                    if (action === collection_1.IBind.ACTION_RESET &&
