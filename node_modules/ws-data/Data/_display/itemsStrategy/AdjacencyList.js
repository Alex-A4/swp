 ...
 * @author Мальцев А.А.
 */
define("Data/_display/itemsStrategy/AdjacencyList", ["require", "exports", "tslib", "Data/_display/GroupItem", "Data/type", "Data/util", "Data/shim", "Core/helpers/Function/throttle"], function (require, exports, tslib_1, GroupItem_1, type_1, util_1, shim_1, throttle) {
    "use strict";
    ...
    function buildTreeIndex(options, parentIndex) {
        ...
        for (var i = 0; i < childrenCount; i++) {
            ...
            if (childContents && idProperty) {
                ...
                result.push.apply(result, itemsToPush);
    ...
    var AdjacencyList = /** @class */ (function (_super) {
        ...
        AdjacencyList.prototype.splice = function (start, deleteCount, added) {
            ...
            var shiftTail = function (start, offset) {
                return function (value) { return value >= start ? value + offset : value; };
            };
            ...
            if (deleteCount > 0) {
                ...
                var removeDeleted = function (deleted) { return function (outer, inner) {
        ...
        AdjacencyList.prototype._createItemsOrder = function () {
            ...
            root = normalizeId(root && typeof root === 'object'
                ? util_1.object.getPropertyValue(root, options.idProperty)
                : root);
            var childrenMap = buildChildrenMap(sourceItems, options.parentProperty);
            var groupsMap = buildGroupsMap(sourceItems);
    ...
    AdjacencyList.prototype['[Data/_display/itemsStrategy/AdjacencyList]'] = true;
    // @ts-ignore
