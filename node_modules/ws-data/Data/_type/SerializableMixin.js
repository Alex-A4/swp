 ...
 * @author Мальцев А.А.
 */
define("Data/_type/SerializableMixin", ["require", "exports", "require", "Data/util"], function (require, exports, requirejs, util_1) {
    "use strict";
    ...
    function serializeCode(instance) {
        ...
        return '{' + Object.keys(proto).map(function (name) {
            return [name, JSON.stringify(proto[name], function (key, value) {
