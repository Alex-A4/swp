 ...
 * @author Мальцев А.А.
 */
define("Data/_type/ObservableMixin", ["require", "exports", "Core/EventBus"], function (require, exports, EventBus) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ObservableMixin /**@lends WS.Data/Entity/ObservableMixin.prototype */ = /** @class */ (function () {
            ...
            if (handlers instanceof Object) {
                for (var event_1 in handlers) {
                    if (handlers.hasOwnProperty(event_1)) {
                        this.subscribe(event_1, handlers[event_1]);
                    }
                }
            }
        }
