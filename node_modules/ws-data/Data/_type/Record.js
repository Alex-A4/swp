 ...
 * @author Мальцев А.А.
 */
define("Data/_type/Record", ["require", "exports", "tslib", "Data/util", "Data/_type/Abstract", "Data/_type/OptionsMixin", "Data/_type/ObservableMixin", "Data/_type/SerializableMixin", "Data/_type/CloneableMixin", "Data/_type/ManyToManyMixin", "Data/_type/ReadWriteMixin", "Data/_type/FormattableMixin", "Data/_type/VersionableMixin", "Data/_type/factory", "Data/util", "Data/shim"], function (require, exports, tslib_1, util_1, Abstract_1, OptionsMixin_1, ObservableMixin_1, SerializableMixin_1, CloneableMixin_1, ManyToManyMixin_1, ReadWriteMixin_1, FormattableMixin_1, VersionableMixin_1, factory_1, util_2, shim_1) {
    "use strict";
    ...
    var Record = /** @class */ (function (_super) {
        ...
        Record.prototype.set = function (name, value) {
            ...
            var changed = this._setPairs(Object.keys(map).map(function (key) {
                return [key, map[key], _this.get(key)];
            }), errors);
            if (changed) {
        ...
        Record.prototype._setPairs = function (pairs, errors) {
            ...
            pairs.forEach(function (item) {
                var key = item[0], value = item[1], oldValue = item[2];
                ...
                if (isEqualValues(value, oldValue)) {
                    ...
                    try {
                        ...
                        //Work with relations
                        _this._addChild(value, _this._getRelationNameForField(key));
                        ...
                        if (value !== oldValue) {
                            ...
                            if (_this._hasChangedField(key) &&
                                getValueOf(_this._getChangedFieldValue(key)) === getValueOf(value)) {
        ...
        Record.prototype.relationChanged = function (which, route) {
            ...
            var checkRawData = function (fieldName, target) {
                ...
                var hasInRawData = adapter.has(fieldName);
            ...
            switch (which.original) {
                case Record.prototype.acceptChanges:
                    if (fieldName && ((target['[Data/_type/Record]'] && !target.isChanged()) ||
                        (target['[Data/_collection/RecordSet]'] && !target.isChanged()))) {
                ...
                default:
                    if (fieldName) {
                        var map = checkRawData(fieldName, target);
        ...
        Record.prototype._getSerializableState = function (state) {
            ...
            state = FormattableMixin_1.default._getSerializableState.call(this, state);
            // @ts-ignore
        ...
        Record.prototype.rejectChanges = function (fields, spread) {
            ...
            this.set(toSet);
            for (var name_1 in toSet) {
                if (toSet.hasOwnProperty(name_1)) {
                    this._unsetChangedField(name_1);
                }
            }
            if (this.getChanged().length === 0) {
        ...
        Record.prototype._setRawDataValue = function (name, value, compatible) {
            if (!compatible &&
                value &&
                value['[Data/_type/FormattableMixin]']) {
        ...
        Record.fromObject = function (data, adapter) {
            ...
            for (var name_2 in data) {
                if (data.hasOwnProperty(name_2)) {
                    sortNames.push(name_2);
                }
            }
            sortNames = sortNames.sort();
            for (var i = 0, len = sortNames.length; i < len; i++) {
                var name_3 = sortNames[i];
                var value = data[name_3];
                if (value === undefined) {
                    continue;
                }
                Record.addFieldTo(record, name_3, value);
            }
            return record;
        };
        /**
    ...
    Record.prototype['[Data/_type/Record]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_collection/IEnumerable]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/ICloneable]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/IEquatable]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/IObject]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/IObservableObject]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/IProducible]'] = true;
    // @ts-ignore
    Record.prototype['[Data/_type/IVersionable]'] = true;
    // @ts-ignore
