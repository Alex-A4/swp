 ...
 * @author Мальцев А.А.
 */
define("Data/_type/FormattableMixin", ["require", "exports", "Data/_type/format", "Data/_type/adapter", "Data/util"], function (require, exports, format_1, adapter_1, util_1) {
    "use strict";
    ...
    function buildFormatFromObject(sliceFormat, rawDataFormat) {
        var field;
        var fieldIndex;
        for (var name_1 in sliceFormat) {
            if (!sliceFormat.hasOwnProperty(name_1)) {
                continue;
            }
            field = sliceFormat[name_1];
            ...
            fieldIndex = rawDataFormat.getFieldIndex(name_1);
            if (fieldIndex === -1) {
    ...
    var FormattableMixin = /** @lends WS.Data/Entity/FormattableMixin.prototype */ {
        ...
        _getAdapter: function () {
            if (this._$adapter === defaultAdapter &&
        ...
        _buildFormat: function (format, fullFormatCallback) {
            ...
            if (format) {
                ...
                if (formatProto === Array.prototype) {
                    var factory = util_1.di.resolve('Data/collection:format.factory');
