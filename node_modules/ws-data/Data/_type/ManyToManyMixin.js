 ...
 * @author Мальцев А.А.
 */
define("Data/_type/ManyToManyMixin", ["require", "exports", "Data/_type/relation/ManyToMany"], function (require, exports, ManyToMany_1) {
    "use strict";
    ...
    var ManyToManyMixin = /** @lends WS.Data/Entity/ManyToManyMixin.prototype */ {
        ...
        _addChild: function (child, name) {
            if (child instanceof Object) {
                ...
                if (child['[Data/_type/ManyToManyMixin]'] &&
