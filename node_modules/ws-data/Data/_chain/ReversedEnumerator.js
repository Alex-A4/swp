 ...
 * @author Мальцев А.А.
 */
define("Data/_chain/ReversedEnumerator", ["require", "exports", "tslib", "Data/_chain/IndexedEnumerator"], function (require, exports, tslib_1, IndexedEnumerator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ReversedEnumerator = /** @class */ (function (_super) {
        ...
        ReversedEnumerator.prototype._getItems = function () {
            if (!this._items) {
                ...
                if (!this.previous.shouldSaveIndices) {
                    this._items = this._items.map(function (item, index) { return [
                        index,
                        item[1]
                    ]; }, this);
                }
