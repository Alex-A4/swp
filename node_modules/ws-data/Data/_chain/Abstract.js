 ...
 * @author Мальцев А.А.
 */
define("Data/_chain/Abstract", ["require", "exports", "tslib", "Data/type", "Data/util"], function (require, exports, tslib_1, type_1, util_1) {
    "use strict";
    ...
    var Abstract = /** @class */ (function (_super) {
        ...
        Abstract.prototype.pluck = function (propertyName) {
            return this.map(function (item) { return util_1.object.getPropertyValue(item, propertyName); });
        };
        /**
        ...
        Abstract.prototype.invoke = function (methodName) {
            ...
            return this.map(function (item) { return item[methodName].apply(item, args); });
        };
        /**
        ...
        Abstract.prototype.count = function (by) {
            if (by === undefined) {
                return this.reduce(function (memo) { return memo + 1; }, 0);
            }
        ...
        Abstract.prototype.max = function () {
            return this.reduce(function (prev, current) { return (current > prev ? current : prev); });
        };
        /**
        ...
        Abstract.prototype.where = function (properties) {
            ...
            return this.filter(function (item) { return keys.reduce(function (prev, key) { return prev && util_1.object.getPropertyValue(item, key) === properties[key]; }, true); });
        };
        /**
        ...
        Abstract.propertyMapper = function (name) {
            ...
            return function (item) { return util_1.object.getPropertyValue(item, name); };
        };
        return Abstract;
    }(type_1.Abstract));
