 ...
 * @author Мальцев А.А.
 */
define("Data/_collection/ObservableList", ["require", "exports", "tslib", "Data/_collection/IBind", "Data/_collection/List", "Data/_collection/EventRaisingMixin", "Data/util"], function (require, exports, tslib_1, IBind_1, List_1, EventRaisingMixin_1, util_1) {
    "use strict";
    ...
    var ObservableList = /** @class */ (function (_super) {
        ...
        ObservableList.prototype.setEventRaising = function (enabled, analyze) {
            var _this = this;
            EventRaisingMixin_1.default.setEventRaising.call(this, enabled, analyze);
        ...
        ObservableList.prototype._notifyItemChange = function (item, properties) {
            ...
            if ((this.hasEventHandlers('onCollectionItemChange') || this.hasEventHandlers('onCollectionChange')) &&
                !this._eventRaising) {
    ...
    ObservableList.prototype['[Data/_collection/ObservableList]'] = true;
    // @ts-ignore
