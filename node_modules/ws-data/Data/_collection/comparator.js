 ...
 * @author Мальцев А.А.
 */
define("Data/_collection/comparator", ["require", "exports", "Data/_collection/IBind"], function (require, exports, IBind_1) {
    "use strict";
    ...
    function applyGroupChanges(groupName, changes, session) {
        ...
        switch (groupName) {
            case 'added':
                before.splice.apply(before, [changes.newItemsIndex, 0].concat(changes.newItems));
                ...
                if (beforeContents !== null) {
                    ...
                    beforeContents.splice.apply(beforeContents, [changes.newItemsIndex, 0].concat(added));
                }
                break;
            case 'removed':
                ...
                break;
            case 'replaced':
                before.splice.apply(before, [changes.oldItemsIndex, changes.oldItems.length].concat(changes.newItems));
                if (beforeContents !== null) {
                    var added = afterContents.slice(changes.newItemsIndex, changes.newItemsIndex + changes.newItems.length);
                    beforeContents.splice.apply(beforeContents, [changes.oldItemsIndex, changes.oldItems.length].concat(added));
                }
                break;
            case 'moved':
                ...
                before.splice(changes.oldItemsIndex, changes.oldItems.length);
                before.splice.apply(before, [afterSpliceIndex, 0].concat(changes.newItems));
                if (beforeContents !== null) {
                    beforeContents.splice(changes.oldItemsIndex, changes.oldItems.length);
                    var added = afterContents.slice(changes.newItemsIndex, changes.newItemsIndex + changes.newItems.length);
                    beforeContents.splice.apply(beforeContents, [afterSpliceIndex, 0].concat(added));
                }
