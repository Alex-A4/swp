 ...
 * @public
 */
define("Data/_collection/RecordSet", ["require", "exports", "tslib", "Data/_collection/IBind", "Data/_collection/ObservableList", "Data/_collection/ArrayEnumerator", "Data/_collection/Indexer", "Data/type", "Data/util", "Core/helpers/Object/isEqual"], function (require, exports, tslib_1, IBind_1, ObservableList_1, ArrayEnumerator_1, Indexer_1, type_1, util_1, isEqualObject) {
    "use strict";
    ...
    var RecordSet = /** @class */ (function (_super) {
        ...
        RecordSet.prototype.getEnumerator = function (state) {
            ...
            enumerator.setResolver(function (index) { return _this.at(index); });
            if (state) {
                enumerator.setFilter(function (record) { return record.getState() === state; });
            }
            return enumerator;
        };
        /**
        ...
        RecordSet.prototype._getIndexer = function () {
            ...
            if (this._$model === this._defaultModel) {
                ...
                indexer = new Indexer_1.default(this._getRawData(), function () { return tableAdapter_1.getCount(); }, function (items, at) { return tableAdapter_1.at(at); }, function (item, property) { return adapter_1.forRecord(item).get(property); });
            }
            else {
                //Slow mode: indexing use record instances
                indexer = new Indexer_1.default(this._$items, function (items) { return items.length; }, function (items, at) { return _this.at(at); }, function (item, property) { return item.get(property); });
            }
    ...
    //Properties defaults
    RecordSet.prototype['[Data/_collection/RecordSet]'] = true;
    // @ts-ignore
    RecordSet.prototype['[Data/_type/IInstantiable]'] = true;
    // @ts-ignore
    RecordSet.prototype['[Data/_type/IObservableObject]'] = true;
    // @ts-ignore
