 ...
 * @author Мальцев А.А.
 */
define("Data/_collection/List", ["require", "exports", "tslib", "Data/_collection/IBind", "Data/_collection/ArrayEnumerator", "Data/_collection/Indexer", "Data/type", "Data/util"], function (require, exports, tslib_1, IBind_1, ArrayEnumerator_1, Indexer_1, type_1, util_1) {
    "use strict";
    ...
    var List = /** @class */ (function (_super) {
        ...
        List.prototype._getIndexer = function () {
            return this._indexer || (this._indexer = new Indexer_1.default(this._$items, function (items) { return items.length; }, function (items, at) { return items[at]; }, function (item, property) { return util_1.object.getPropertyValue(item, property); }));
        };
        /**
        ...
        List.prototype._splice = function (items, start, action) {
            ...
            (_a = this._$items).splice.apply(_a, [start, 0].concat(items));
    ...
    //Properties defaults
    List.prototype['[Data/_collection/List]'] = true;
    // @ts-ignore
    List.prototype['[Data/_collection/IEnumerable]'] = true;
    // @ts-ignore
    List.prototype['[Data/_collection/IIndexedCollection]'] = true;
    // @ts-ignore
    List.prototype['[Data/_collection/IList]'] = true;
    // @ts-ignore
    List.prototype['[Data/_type/ICloneable]'] = true;
    // @ts-ignore
    List.prototype['[Data/_type/IEquatable]'] = true;
    // @ts-ignore
    List.prototype['[Data/_type/IVersionable]'] = true;
    // @ts-ignore
