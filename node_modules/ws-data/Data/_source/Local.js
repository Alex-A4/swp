 ...
 * @author Мальцев А.А.
 */
define("Data/_source/Local", ["require", "exports", "tslib", "Data/_source/Base", "Data/_source/DataMixin", "Data/_source/DataCrudMixin", "Data/util", "Core/Deferred", "Core/helpers/Number/randomId"], function (require, exports, tslib_1, Base_1, DataMixin_1, DataCrudMixin_1, util_1, Deferred, randomId) {
    "use strict";
    ...
    var Local = /** @class */ (function (_super) {
        ...
        Local.prototype.read = function (key, meta) {
            ...
            if (data) {
                return this._loadAdditionalDependencies().addCallback(function () { return _this._prepareReadResult(data); });
            }
            else {
        ...
        Local.prototype.update = function (data, meta) {
            ...
            return this._loadAdditionalDependencies().addCallback(function () { return _this._prepareUpdateResult(data, keys); });
        };
        ...
        Local.prototype.query = function (query) {
            ...
            return this._loadAdditionalDependencies().addCallback(function () { return _this._prepareQueryResult({
                items: items,
                meta: {
                    total: total
                }
        ...
        Local.prototype.copy = function (key, meta) {
            ...
            if (index === -1) {
                ...
                this._reIndex();
                return this._loadAdditionalDependencies().addCallback(function () { return _this._prepareReadResult(copy_1); });
            }
        };
        ...
        Local.prototype._applyWhere = function (data, where) {
            ...
            var checkFields = function (fields, item) {
                ...
                for (var name_1 in fields) {
                    ...
                    result = compareValues(item.get(name_1), fields[name_1], '=');
                    if (!result) {
                        break;
                    }
                }
    ...
    Local.prototype['[Data/_source/Local]'] = true;
    // @ts-ignore
