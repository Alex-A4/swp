...
import {Abstract, Model, OptionsMixin, SerializableMixin, adapter} from '../type';
...
export default class DataSet extends mixin(
   Abstract, OptionsMixin, SerializableMixin
    ...
    * @name WS.Data/Source/DataSet#metaProperty
    * @see getMetaProperty
    */
...
DataSet.prototype['[Data/_source/DataSet]'] = true;
// @ts-ignore
DataSet.prototype._$adapter = 'Data/type:adapter.Json';
// @ts-ignore
DataSet.prototype._$rawData = null;
// @ts-ignore
DataSet.prototype._$model = 'Data/type:Model';
// @ts-ignore
DataSet.prototype._$listModule = 'Data/collection:RecordSet';
// @ts-ignore
...
di.register('Data/source:DataSet', DataSet, {instantiate: false});
