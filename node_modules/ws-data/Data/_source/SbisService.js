 ...
 * @author Мальцев А.А.
 */
define("Data/_source/SbisService", ["require", "exports", "tslib", "Data/_source/Rpc", "Data/_source/OptionsMixin", "Data/_source/DataMixin", "Data/util", "Core/ParallelDeferred"], function (require, exports, tslib_1, Rpc_1, OptionsMixin_1, DataMixin_1, util_1, ParallelDeferred) {
    "use strict";
    ...
    var SbisService = /** @class */ (function (_super) {
        ...
        SbisService.prototype.update = function (data, meta) {
            ...
            if (this._$binding.updateBatch && DataMixin_1.default.isListInstance(data)) {
                return this._loadAdditionalDependencies(function (def) {
                    _this._connectAdditionalDependencies(_this._callProvider(_this._$binding.updateBatch, passUpdateBatch(data, meta)).addCallback(function (key) { return _this._prepareUpdateResult(data, key); }), def);
                });
            }
        ...
        SbisService.prototype.destroy = function (keys, meta) {
            ...
            for (var name_1 in groups) {
                if (groups.hasOwnProperty(name_1)) {
                    pd.push(callDestroyWithComplexId(this, groups[name_1], name_1, meta));
                }
            }
        ...
        SbisService.prototype.move = function (items, target, meta) {
            ...
            for (var name_2 in groups) {
                if (groups.hasOwnProperty(name_2)) {
                    meta.objectName = name_2;
                    var def = this._callProvider(this._$binding.move.indexOf('.') > -1 ?
                        this._$binding.move :
                        this._$endpoint.moveContract + '.' + this._$binding.move, this._$passing.move.call(this, groups[name_2], target, meta));
                    if (groupsCount === 1) {
    ...
    SbisService.prototype._moduleName = 'Data/source:SbisService';
    // @ts-ignore
