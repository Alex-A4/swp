 ...
 * @author Мальцев А.А.
 */
define("Data/_source/LazyMixin", ["require", "exports", "Core/Deferred", "require"], function (require, exports, Deferred, req) {
    "use strict";
    ...
    var LazyMixin = /** @lends WS.Data/Source/LazyMixin.prototype */ {
        ...
        _loadAdditionalDependencies: function (callback) {
            ...
            var depsLoaded = deps.reduce(function (prev, curr) { return prev && req.defined(curr); }, true);
            ...
            if (depsLoaded) {
                ...
                }, function (error) { return result.errback(error); });
            }
            return result;
        },
        /**
