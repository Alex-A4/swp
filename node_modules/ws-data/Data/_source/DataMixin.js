 ...
 * @author Мальцев А.А.
 */
define("Data/_source/DataMixin", ["require", "exports", "Data/type", "Data/util"], function (require, exports, type_1, util_1) {
    "use strict";
    ...
    var DataMixin = /** @lends WS.Data/Source/DataMixin.prototype */ {
        ...
        isModelInstance: function (instance) {
            return instance &&
                instance['[Data/_type/IObject]'] &&
                instance['[Data/_type/FormattableMixin]'];
        },
        /**
        ...
        isListInstance: function (instance) {
            return instance &&
                instance['[Data/_collection/IList]'] &&
                instance['[Data/_type/FormattableMixin]'];
        }
        //endregion Statics
    };
