 ...
 * @author Мальцев А.А.
 */
define("Data/_source/Remote", ["require", "exports", "tslib", "Data/_source/Base", "Data/_source/DataMixin", "Data/_source/DataCrudMixin", "Data/_source/BindingMixin", "Data/_source/EndpointMixin", "Data/_source/OptionsMixin", "Data/type", "Data/util", "require"], function (require, exports, tslib_1, Base_1, DataMixin_1, DataCrudMixin_1, BindingMixin_1, EndpointMixin_1, OptionsMixin_1, type_1, util_1, req) {
    "use strict";
    ...
    var Remote = /** @class */ (function (_super) {
        tslib_1.__extends(Remote, _super);
        // @ts-ignore
        function Remote(options) {
            var _this = this;
            //region ICrud
            _this['[Data/_source/ICrud]'] = true;
            //endregion
            //region ICrudPlus
            _this['[Data/_source/ICrudPlus]'] = true;
            //endregion
            //region IProvider
            _this['[Data/_source/IProvider]'] = true;
            // @ts-ignore
            BindingMixin_1.default.constructor.call(_this, options);
            // @ts-ignore
        ...
        Remote.prototype.create = function (meta) {
            var _this = this;
            return this._callProvider(this._$binding.create, this._$passing.create.call(this, meta)).addCallback(function (data) { return _this._loadAdditionalDependencies().addCallback(function () { return _this._prepareCreateResult(data); }); });
        };
        Remote.prototype.read = function (key, meta) {
            var _this = this;
            return this._callProvider(this._$binding.read, this._$passing.read.call(this, key, meta)).addCallback(function (data) { return _this._loadAdditionalDependencies().addCallback(function () { return _this._prepareReadResult(data); }); });
        };
        Remote.prototype.update = function (data, meta) {
            var _this = this;
            return this._callProvider(this._$binding.update, this._$passing.update.call(this, data, meta)).addCallback(function (key) { return _this._prepareUpdateResult(data, key); });
        };
        ...
        Remote.prototype.query = function (query) {
            var _this = this;
            return this._callProvider(this._$binding.query, this._$passing.query.call(this, query)).addCallback(function (data) { return _this._loadAdditionalDependencies().addCallback(function () { return _this._prepareQueryResult(data); }); });
        };
        ...
        Remote.prototype.copy = function (key, meta) {
            var _this = this;
            return this._callProvider(this._$binding.copy, this._$passing.copy.call(this, key, meta)).addCallback(function (data) { return _this._prepareReadResult(data); });
        };
    ...
    Remote.prototype['[Data/_source/Remote]'] = true;
    // @ts-ignore
    ...
    Remote.prototype._moduleName = 'Data/source:Remote';
    // @ts-ignore
