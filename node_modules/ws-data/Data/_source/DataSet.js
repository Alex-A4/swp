 ...
 * @author Мальцев А.А.
 */
define("Data/_source/DataSet", ["require", "exports", "tslib", "Data/type", "Data/util"], function (require, exports, tslib_1, type_1, util_1) {
    "use strict";
    ...
    var DataSet = /** @class */ (function (_super) {
        ...
        DataSet.prototype.getAll = function (property) {
            ...
            if (this._$metaProperty && items.getMetaData instanceof Function) {
                ...
                var someInMetaData = Object.keys(metaData).length > 0;
